...
<div class="my-5 px-4">
    ...
    All our contact details, including our address, phone number, and location map, are provided below.
    </p>
</div>
...
<?php 
// Close connection only after all database operations are done
$conn->close();
